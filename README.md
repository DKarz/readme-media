...
<p align="center">
If we tried to buy something for a very low price, our order would not be executed but would go to the system orders stack:<br/><br/>
  <img width="750" src="https://github.com/DKarz/media-lfs/blob/master/GUI/gui5.gif?raw=true">
  <br/><br/><br/>
</p>
